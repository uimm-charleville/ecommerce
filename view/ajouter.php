...
<body>
    <div class="album py-5 bg-light">
        <div class="container">
            <div class="row row-cols-1 row cols-sm-2 row-cols-md-3 g-3">
                <form action="?admin=&action=addProduct" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
    ...
    <div>
        <center><button type="submit" onclick="document.location.href = '?admin=&action=';" class="btn btn-primary" name="valider">Retour</button><center>
    </div>
