    ...
    <div class="album py-5 bg-light">
        <div class="container">
            <div class="row row-cols-1 row cols-sm-2 row-cols-md-3 g-3">
                <form action="?admin=&action=EditProduct&idProduct=<?php echo $product->id ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Nom du produit</label>
                        <input type="text" class="form-control" name="nom" placeholder="<?= $product->name ?>" >
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="prix" placeholder="<?= $product->prix ?>" >
                    </div>
