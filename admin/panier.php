...
$nbr_produit = count($_SESSION['panier']);
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <center><button type="submit" onclick="document.location.href = '';" class="btn btn-primary" name="valider" >Valider le panier</button><center>
                </div>
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr><td colspan='4'><center>Panier</td></center></tr>
                        <tr>
                            <th>Nom produit<i class="fa fa-sort"></i></th>
                            <th>Prix Unitaire</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    
                    <?php for ($i=0; $i<$nbr_produit; $i++): ?>
                    <tbody>
                        <tr>
                            <td><?php echo $_SESSION['panier'][$i]['nom_produit'] ?></td>
                            <td><?php echo $_SESSION['panier'][$i]['prix'] ?>€</td>
                            <td>
                                <!--<a href="buy_produit.php?id=<?= $produit->id ?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>-->
                                <button class='delete_basket btn btn-danger' id='buy' data-id= '<?= $id =$_SESSION['panier'][$i]['id_produit'] ?>' onclick='confirm_del_basket()' title="Supprimer du panier" data-toggle="tooltip"><i class="material-icons">&#xE15b;</i></button>
